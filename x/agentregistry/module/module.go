...
// Module is a GenesisOnlyAppModule — it only participates in genesis, no invariants/upgrades.
type Module struct {
...
func (basic) Name() string                { return "agentregistry" }
...
func (basic) DefaultGenesis(codec.JSONCodec) json.RawMessage   { return json.RawMessage(`{"agents":[]}`) }
func (basic) ValidateGenesis(codec.JSONCodec, client.TxEncodingConfig, json.RawMessage) error { return nil }

func (basic) InitGenesis(ctx sdk.Context, cdc codec.JSONCodec, data json.RawMessage) []abci.ValidatorUpdate {
	return nil
}
func (basic) ExportGenesis(ctx sdk.Context, cdc codec.JSONCodec) json.RawMessage {
